...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    _fwhm6.gii ...
    [fetch_surf_nki_enhanced] Downloaded 18169856 of 42412120 bytes (42.8%%,    1.3s
    remaining)
    [fetch_surf_nki_enhanced] Downloaded 36151296 of 42412120 bytes (85.2%%,    0.3s
    remaining)
    ...
    _fwhm6.gii ...
    [fetch_surf_nki_enhanced] Downloaded 17154048 of 42402060 bytes (40.5%%,    1.5s
    remaining)
    [fetch_surf_nki_enhanced] Downloaded 35364864 of 42402060 bytes (83.4%%,    0.4s
    remaining)
    [fetch_surf_nki_enhanced]  ...done. (3 seconds, 0 min)
