...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    _fwhm6.gii ...
    [fetch_surf_nki_enhanced] Downloaded 15843328 of 42412120 bytes (37.4%%,    1.7s
    remaining)
    [fetch_surf_nki_enhanced] Downloaded 31178752 of 42412120 bytes (73.5%%,    0.7s
    remaining)
    ...
    _fwhm6.gii ...
    [fetch_surf_nki_enhanced] Downloaded 16785408 of 42402060 bytes (39.6%%,    1.5s
    remaining)
    [fetch_surf_nki_enhanced] Downloaded 33562624 of 42402060 bytes (79.2%%,    0.5s
    remaining)
    [fetch_surf_nki_enhanced]  ...done. (3 seconds, 0 min)
